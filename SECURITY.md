...
The canonical version for `aaprop` will be the one that is deployed to [`aaprop.shuttleapp.dev`](https://aaprop.shuttleapp.dev). We will also support the current major version of the application in terms of security patches and issues.
